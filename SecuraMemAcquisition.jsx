...
const SecuraMemAcquisitionPage = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-slate-800">
        ...
        <div className="mt-12 bg-slate-950/50 border border-slate-700 rounded-xl p-8">
          ...
          <code className="text-sm text-slate-400 font-mono bg-slate-900 px-4 py-3 rounded block">
...
export default SecuraMemAcquisitionPage;
